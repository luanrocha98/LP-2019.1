...
int main(){
	...
	cientec.adicionarFuncionario("Luan", "70330610481", 400, date(30,12,2018)); // tentando adicionar luan novamente.
	...
	Empresa teczoo("TECZOO", "276143714263");

	teczoo.adicionarFuncionario("Luan Rocha", "70330610481", 100.00, date(30,06,2018)); // adicionando Luan a empresa teczoo.
	teczoo.adicionarFuncionario("Elyton Victor", "70335610481", 200.00, date(30,12,2018)); // adicionando Elyton a empresa teczoo.
	teczoo.adicionarFuncionario("Habib Fonseca", "72430610481", 300.00, date(30,03,2018)); // adicionando Habib a empresa teczoo.


	std::cout << "Média de funcionarios por empresa: " << cientec.mediaDeFuncPorEmpresas() << std::endl;
